  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        // biome-ignore lint/correctness/noNestedComponentDefinitions: DayButton needs the locale prop from this render's closure
...
const CalendarChevron: NonNullable<CalendarComponents["Chevron"]> = ({ className, orientation, ...props }) => {
  if (orientation === "left") {
...
const CalendarWeekNumber: NonNullable<CalendarComponents["WeekNumber"]> = ({ children, ...props }) => (
  <td {...props}>
