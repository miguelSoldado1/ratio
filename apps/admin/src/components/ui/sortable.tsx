...
const ARROW_KEY_HINTS: Record<string, string> = {
  ...
  const screenReaderInstructions: ScreenReaderInstructions = React.useMemo(
    () => ({
      draggable: `
        ...
        While dragging, use the ${ARROW_KEY_HINTS[orientation] ?? "arrow"} keys to move the item.
...
function renderOverlayChildren(children: SortableOverlayProps["children"], activeId: UniqueIdentifier | null) {
  if (!activeId) return null;
  return typeof children === "function" ? children({ value: activeId }) : children;
}
  ...
  return ReactDOM.createPortal(
    ...
    >
      <SortableOverlayContext.Provider value={true}>
        {renderOverlayChildren(children, context.activeId)}
