...
describe("PageContainer", () => {
  it("separates the painted page rail from its margin-based content gutters", () => {
    render(
    ...
    expect(content.classList.contains("mx-5")).toBe(true);
    expect(content.classList.contains("lg:mx-10")).toBe(true);
