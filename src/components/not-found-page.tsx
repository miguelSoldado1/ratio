...
export function NotFoundPage() {
  ...
  return (
    <main className="min-h-[calc(100svh-4rem)] bg-background text-foreground">
      <PageContainer className="flex min-h-[calc(100svh-4rem)] flex-col items-center justify-center py-12">
        <article className="flex w-full max-w-md flex-col items-center text-center">
          ...
          <p className="mt-3 max-w-sm text-muted-foreground text-sm leading-6">
            We couldn't find an album, review, or profile at this address. Head back to the feed, or search for what you
            were after.
          </p>
